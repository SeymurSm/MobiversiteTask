...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        boolean rememeber = tinyDB.getBoolean("REMEMBER");
        ...
        rippleSwitch.setOnCheckedChangeListener(new RippleSwitch.OnCheckedChangeListener() {
            ...
            public void onCheckChanged(boolean b) {
                if(b)
                    tinyDB.putBoolean("REMEMBER",true);
                else
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            tinyDB.putString("USERNAME", email);
            tinyDB.putString("PASSWORD", password);
            if(email.equals("ankara") && password.equals("123hh4")) {
                showProgress(true);
                mAuthTask = new UserLoginTask(email, password);
                mAuthTask.execute((Void) null);
                startActivity(new Intent(LoginActivity.this, MainActivity.class));
            }else{
                if(email.equals("ankara")){
